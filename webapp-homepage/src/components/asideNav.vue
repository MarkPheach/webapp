<template>
  <aside
    class="fixed left-0 min-h-[calc(100vh-10vh)] max-w-[20vw] bg-blue-300 flex flex-col items-center">
    ...
    <div class="flex flex-col my-5 px-2 w-[95%]">
      <ul>
        <router-link to="/HomeInventory">
          <li class="text-white text-3xl hover:text-5xl transition duration-300">
