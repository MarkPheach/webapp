...
<template>
    <div>
        ...
        <!--โปรไฟล์เฟรม 1-->
        <div>
            <button @click="purchasePopup('ProfileFrame1', 30)">
                <v-card
        ...
        <!--โปรไฟล์เฟรม 2-->
        <div>
            <button @click="purchasePopup('ProfileFrame2', 30)">
                <v-card
        ...
        <!--โปรไฟล์เฟรม 3-->
        <div>
            <button @click="purchasePopup('ProfileFrame3', 30)">
                <v-card
        ...
        <!--โปรไฟล์เฟรม 4-->
        <div>
            <button @click="purchasePopup('ProfileFrame4', 30)">
                <v-card
